  ...
  export default {
    ...
    data () {
      return {
        ...
        maxImgsNum:3,
        images:[
          {url:"/mobile_src/imgs/upload/878619173.jpeg"},
          {url:"/mobile_src/imgs/upload/884334763.jpeg"},
          {url:"/mobile_src/imgs/upload/1491322234.jpeg"},
        ],
    ...
    methods: {
      onChange(e){
        ...
        this.$http.post('/preFlightApi/PreFlight/personal/flightPlanList.do',formData,{headers: {
